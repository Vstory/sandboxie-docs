...
[功能对比](FeatureComparison.md)

[文件菜单](FileMenu.md)

[文件迁移设置](FileMigrationSettings.md)

[文件根路径](FileRootPath.md)
...
[MSI 安装程序豁免](MsiInstallerExemptions.md)
...
[读取注册表项路径](ReadKeyPath.md)

[恢复文件夹](RecoverFolder.md)
